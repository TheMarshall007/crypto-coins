import 'package:crypto_coins/database/db.dart';
import 'package:crypto_coins/models/historico.dart';
import 'package:crypto_coins/models/moeda.dart';
import 'package:crypto_coins/models/posicao.dart';
import 'package:crypto_coins/repositories/moeda_repository.dart';
  ...
  _getHistorico() async {
    ...
    operacoes.forEach((operacao) {
      ...
      _historico.add(Historico(
        ...
        moeda: moeda,
        valor: double.parse(operacao['valor']),
